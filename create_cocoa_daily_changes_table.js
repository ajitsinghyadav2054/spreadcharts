...
await pool.query(`
    CREATE TABLE IF NOT EXISTS cocoa_us_daily_changes (
    ...
    CREATE INDEX IF NOT EXISTS idx_cocoa_us_daily_changes_date ON cocoa_us_daily_changes (trade_date DESC);
`);

console.log('✅ Table cocoa_us_daily_changes created successfully!');
process.exit(0);
